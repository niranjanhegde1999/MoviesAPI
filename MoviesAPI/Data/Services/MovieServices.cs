    ...
    public class MovieServices
    {
        ...
        public List<MovieWithNamesVM> GetAllMovies()
        {
            var _movieWithNamesVMs = _context.Movies.Select(movie => new MovieWithNamesVM()
            {
                ...
                movie_actors = movie.movie_actors.Select(ma => ma.actor.actor_name).ToList(),
        ...
        public int AddMovie(MovieVM movie)
        {
            ...
            foreach(var actorId in movie.actor_ids)
            {
                ...
                _context.Movie_Actors.Add(_movie_actors);
                _context.SaveChanges();
            }
        ...
        public bool UpdateMovie(int movieId, MovieVM movie)
        {
            ...
            if (_movie != null)
            {
                ...
                var _movieActors = _context.Movie_Actors.Where(ma => ma.movie_id == movieId);
                _context.Movie_Actors.RemoveRange(_movieActors);
                _context.SaveChanges();
